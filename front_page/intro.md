...
- Im **4. Schritt** evaluieren wir die OCR-Ergebnisse und testen Optionen zur Nachkorrektur (siehe Kapitel ["OCR-Nachbereitung. Manuell, automatisch, LLMs"](post-correcting_intro)).
